...
#ifndef BOOST_TAAR_HANDLER_REST_ERROR_HPP
#define BOOST_TAAR_HANDLER_REST_ERROR_HPP
...
inline boost::system::error_category const& error_category() noexcept
{
    struct error_category_type : boost::system::error_category
    {
        ...
        {
            return "boost::taar::handler::rest";
        }
...
template<>
struct is_error_code_enum<::boost::taar::handler::rest_error>
{
...
#endif // BOOST_TAAR_HANDLER_REST_ERROR_HPP
