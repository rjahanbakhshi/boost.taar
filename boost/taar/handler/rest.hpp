        ...
        ))
    {
        co_return co_await response_from_invoke(
            ...
            get_rest_arg<
                type_traits::callable_arg<noref_fn_type, Indexes>,
                std::tuple_element_t<Indexes, arg_providers_tuple_t>
            >(std::get<Indexes>(arg_providers_tuple), Indexes, request, context)...
        );
    };
}
