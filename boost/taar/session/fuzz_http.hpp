...
public:
    ...
    fuzz_http(fuzz_http const&) = delete;
    fuzz_http(fuzz_http&&) = default;
    fuzz_http& operator=(fuzz_http const&) = delete;
    fuzz_http& operator=(fuzz_http&&) = default;
    ~fuzz_http() = default;
        ...
        cancellation_signals& signals)
    {
        ...
        try
        {
                ...
                cs = co_await this_coro::cancellation_state)
            {
                ...
                auto header_sz = co_await http::async_read_header(
                    stream,
                    buffer,
                    header_parser);
                    ...
                    req_header.payload_size().value() > 0)
                {
                    ...
                    auto req_sz = co_await async_read(
                        stream,
                        buffer,
                        body_parser);
                ...
                auto resp_sz = co_await http::async_write(
                    stream,
                    response);
        ...
        RequestHandler request_handler)
    {
        ...
        matcher_handlers_.emplace_back(
            ...
            -> awaitable<bool>
            {
                ...
                auto req_sz = co_await async_read(stream, buffer, body_parser);
